...
const MediaModal = ({
  ...
  const handleClear = () => {
    ...
    showToast("Media selection cleared.","success")
  };
  const handleClose = () => {
  ...
  const handleSelect = () => {
  console.log("SELECT CLICKED", selectedMedia);
    if (selectedMedia.length <= 0) {
      return showToast("Please select a media.", "error");
    }
  ...
  return (
    <Dialog open={open} onOpenChange={() => setOpen(!open)}>
      ...
      >
        ...
        <div className="h-90[vh] bg-white p-3 rounded-shadow">
